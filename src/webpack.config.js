...
const wpkgUtils = require('../rte-dev-utils/lib/wpkg-utils.js');
const distFolder = path.resolve(
  __dirname,
  '../dist',
  wpkgUtils.getWebpackageName
);
...
const baseConfig = {
  ...
  plugins: [
    ...
    new GenerateJsonPlugin(
      'manifest.webpackage',
      wpkgUtils.getManifestWebpackage,
      null,
      2
    )
  ],
...
const subConfigs = find.fileSync(
  /webpack\.subconfig.js$/,
