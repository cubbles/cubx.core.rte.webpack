...
import webpackageDocument from './cache/webpackageDocument';
import simpleWebpackageDocument from './cache/webpackageDocument-simple';
...
describe('Cache', function () {
  ...
  before(function () {
    ...
    webpackageDocumentObject = webpackageDocument;
    simpleWebpackageDocumentObject = simpleWebpackageDocument;
  });
  after(function () {
  ...
  describe('#addComponentCacheEntry', function () {
    ...
    it('should be contains in the _componentCache as object', function () {
      ...
      cache._componentCache[artifactId].should.have.property(
        'artifactId',
  ...
  describe('#_addComponentCacheEntry', function () {
    ...
    describe('add componentEntry, if an the component with the same artifactId already in cache', function () {
  ...
  describe('#_findComponentInDocument', function () {
    describe('in document with all artefacts', function () {
      it('should find the component with artifactId "my-elementary"', function () {
        var artifactId = 'my-elementary';
        var artifact = cache._findComponentInDocument(
          webpackageDocumentObject,
          artifactId
        );
    ...
    describe('without compoundComponent and elementaryComponent artifacts,', function () {
      it('should not find the component with artifactId', function () {
        ...
        var artifact = cache._findComponentInDocument(
          simpleWebpackageDocumentObject,
          artifactId
        );
        expect(artifact).to.be.null;
      });
