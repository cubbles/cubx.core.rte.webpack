...
import DependencyMgr from '../../modules/dependencyManager/depMgr';
...
describe('DependencyTree', function () {
  ...
  describe('#toJSON()', function () {
    it('should return an object describing the dependency tree as JSON object', function () {
      rootNode1.data = new DependencyMgr.DepReference({
        webpackageId: 'com.example.package1@1.0',
        artifactId: 'comp-1',
        referrer: null
      });
      childC.data = new DependencyMgr.DepReference({
        webpackageId: 'com.example.packageC@1.0',
        artifactId: 'comp-c',
        referrer: null
      });

      rootNode2.data = new DependencyMgr.DepReference({
        webpackageId: 'com.example.package2@1.0',
        artifactId: 'comp-2',
        referrer: null
      });
      childA.data = new DependencyMgr.DepReference({
        webpackageId: 'com.example.packageA@1.0',
        artifactId: 'comp-a',
        referrer: null
      });
      childB.data = new DependencyMgr.DepReference({
    ...
    it("should assign correct values to 'usesExisting' and 'usedBy' properties", function () {
      ...
      childD.data = new DependencyMgr.DepReference({
      ...
      childD2.data = new DependencyMgr.DepReference({
        webpackageId: 'com.example.packageD@1.0',
        artifactId: 'comp-d',
        referrer: {
          webpackageId: 'com.example.packageA@1.0',
...
describe('DependencyTree.Node', function () {
  ...
  describe('#toJSON()', function () {
    it('should return an object describing the node as JSON object', function () {
      ...
      childF.data = new DependencyMgr.DepReference({
        webpackageId: 'com.example.packageF@1.0',
        artifactId: 'comp-f',
        referrer: null
      });
      childG.data = new DependencyMgr.DepReference({
        webpackageId: 'com.example.packageG@1.0',
        artifactId: 'comp-g',
        referrer: null
      });
      childH.data = new DependencyMgr.DepReference({
        ...
        children: [
          {
            ...
            usesExisting: [
              { webpackageId: 'com.example.packageH@1.0', artifactId: 'comp-h' }
            ],
            usedBy: []
          },
          {
