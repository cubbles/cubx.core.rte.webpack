...
describe('CRCLoader', function () {
  ...
  describe('#_checkRootDependencies()', function () {
    ...
    describe('root dependencie included only valid entries', function () {
      ...
      beforeEach(function () {
        ...
        origRootDependencies = origRootDependencies.concat(
          window.cubx.CRCInit.rootDependencies
        );
      });
      afterEach(function () {
      ...
      it('rootDependencies should be keeped', function () {
        crcLoader._checkRootDependencies();
        window.cubx.CRCInit.rootDependencies.should.be.eql(
          origRootDependencies
        );
      });
    });
    describe('root dependencie included valid and not valid entries', function () {
      ...
      beforeEach(function () {
        ...
        window.cubx.CRCInit.rootDependencies.push(
          'other.example@1.4.5/other-artifact/main'
        );
      ...
      it('rootDependencies should included just the object elements, the string elements will be deleted', function () {
        crcLoader._checkRootDependencies();
        window.cubx.CRCInit.rootDependencies.should.be.not.eql(
          origRootDependencies
        );
  ...
  describe('processing  after start event', function () {
    ...
    beforeEach(function () {
      ...
      _checkRootDependenciesStub = sinon
        .stub(crcLoader, '_checkRootDependencies')
        .callsFake(function () {
          // do nothing;
        });
      _addComponentDependenciesToRootDependenciesStub = sinon
        .stub(crcLoader, '_addComponentDependenciesToRootDependencies')
        .callsFake(function () {
          // do nothing;
        });
      _addDependenciesAndExcludesToRootDependenciesStub = sinon
        .stub(crcLoader, '_addDependenciesAndExcludesToRootDependencies')
        .callsFake(function () {
          // do nothing;
        });
      _bootstrapCRCStub = sinon
        .stub(crcLoader, '_bootstrapCRC')
        .callsFake(function () {
          // do nothing;
        });
    ...
    describe('processing will be done', function () {
      ...
      it('_addDependenciesAndExcludesToRootDependencies should be called once', function (done) {
        window.setTimeout(function () {
          _addDependenciesAndExcludesToRootDependenciesStub
